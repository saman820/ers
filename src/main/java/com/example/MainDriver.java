...
//		String saltt2= new Salt().generateSalt(512).get();
//		String password = "test123dd";
//		String key = new Hashing().hashPassword(password, saltt2).get();
//		System.out.println(new Hashing().verifyPassword("test123dd", key, saltt2));
